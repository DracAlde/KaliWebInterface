...
<body>
	...
	<section>
			...
			<div class="panel-footer">
				...
				<div id="form">
					<form method="POST" action="<c:url value="/hydra" ></c:url>">
						...
						<div>
							<label for="protocol" data-toggle="tooltip" title="help" />
							Protocol </label>
							<div class="input-group col-lg-2 col-mg-4 col-sm-6"">
								<select class="form-control" name="protocol" id="protocol"
									...
									data-toggle="tooltip" title="help" data-placement="bottom">
						...
						<fieldset class="col-sm-6 col-md-6 col-lg-6">
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								<input type="radio" name="account" value="known"
									id="account_known" checked="checked"
									onclick="printAccountForm()" /> <label for="known"><c:out
								...
								<br> <input type="radio" name="account" value="dictionary"
									id="account_radio_dictionary" onclick="printAccountForm()" />
								<label for="dictionary"><c:out
							...
							<div class="col-sm-6 col-md-6 col-lg-6" id="account_name">
								...
								<div class="input-group">
									<input type="text" class="form-control"
										placeholder="Nom du compte" name="account_name_field"
										id="account_name_field" onkeyup="updateCommand()"
							...
							<div id="account_dictionary" class='hidden'>
								...
								<div class="input-group col-lg-6 col-mg-6 col-sm-6">
									<select class="form-control" name="account_dico_type"
										id="account_dico_type" onchange="updateCommand()" autofocus
										required>
						...
						<fieldset class="col-sm-6 col-md-6 col-lg-6">
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								<input type="radio" name="password" value="known"
									id="password_known" checked="checked"
									onclick="printPasswordForm()" /> <label for="known"><c:out
								...
								<br> <input type="radio" name="password" value="dictionary"
									id="password_radio_dictionary" onclick="printPasswordForm()" />
								<label for="dictionary"><c:out
							...
							<div id="password">
								...
								<div class="input-group">
									<input type="text" class="form-control"
										placeholder="Mot de passe" name="password_field"
										id="password_field" onkeyup="updateCommand()"
										onselect="updateCommand()" autofocus> <span
										class="input-group-addon" id="basic-addon2"
										data-toggle="tooltip"
										title="<c:out value="${language.getLanguageValue('hydra', '/hydra/aide/cible')}" />"
							...
							<div id="password_dictionary" class='hidden'>
								...
								<div class="input-group col-lg-6 col-mg-6 col-sm-6">
									<select class="form-control" name="password_dico_type"
										id="password_dico_type" onchange="updateCommand()" autofocus
										required>
										<option value="big-dico" id="big-dico" title="dictionary"><c:out
												value="${language.getLanguageValue('hydra', '/hydra/options/dictionnaire/grand-dico')}" /></option>
										<option value="med-dico" id="med-dico" title="dictionary"><c:out
		...
		<script>
			var target = document.getElementById('target'), account_radio_name = document
					.getElementById('account_known'), account_radio_dico = document
					.getElementById('account_radio_dictionary'), account_name = document
					.getElementById('account_name'), account_name_field = document
					.getElementById('account_name_field'), account_dictionary = document
					.getElementById('account_dictionary'), password_radio_name = document
					.getElementById('password_known'), password_radio_dico = document
					.getElementById('password_radio_dictionary'), password = document
					.getElementById('password'), password_field = document
					.getElementById('password_field'), password_dictionary = document
					.getElementById('password_dictionary'), command = document
					.getElementById('command'), protocol = document
			...
			function updateCommand() {
				...
				command_string = '> hydra ' + account_opt + ' ' + password_opt
						+ ' ' + protocol_txt + target_txt;
				...
				setTimeout(
						function() {
							...
							xhr
									.open(
											"GET",
											"<c:url value='/asyncrequest?tool=hydra' ></c:url>",
											true);
							xhr.send(null);
